    ...
    <aside className="right-sidebar">
      ...
      <section className="banks">
        ...
        {banks?.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 p-6 text-center text-gray-500">
            <p className="text-14 font-medium">No banks connected yet</p>
          </div>
        )}
